...
public final class CardManager
{
	...
	private static final String SP = "<br/><img src=\"spliter\"/><br/>"; //插入图片 <img src="图形文件名">
	...
	public static String buildResult(String n, String i, String d, String x)
	{
		...
		s.append("<br/><b>").append(n).append("</b>"); //n 粗体
	...
	public static String load(Parcelable parcelable, Resources res)
	{
		...
		if (isodep != null)
		{
			LogUtil.d(MyConstant.TAG, TAG_ASSIST + "load, isodep");
		...
		if (nfcv != null)
		{
			LogUtil.d(MyConstant.TAG, TAG_ASSIST + "load, nfcv");
		...
		if (nfcf != null)
		{
			LogUtil.d(MyConstant.TAG, TAG_ASSIST + "load, nfcf");
